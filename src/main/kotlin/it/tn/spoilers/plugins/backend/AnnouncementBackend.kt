    ...
    routing {
        post("/insert/announcement") {
            ...
            if (UserSession != null && UserData != null) {
                ...
                AnnouncementsService().assistedCreate(formParameters["announcement-user"]?.toString() ?: "",formParameters["announcement-isbn"]?.toLongOrNull() ?: 0L,"disponibile",
                    formParameters["announcement-price"]?.toDoubleOrNull() ?: 0.0,formParameters["announcement-stato"].toString(),formParameters["announcement-description"]?.toString() ?: "",Ebook)
